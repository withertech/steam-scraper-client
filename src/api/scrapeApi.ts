...
export class ScrapeApi {
     ...
     */
    public async scrape (filename: string, md5: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ImagesResult | ErrorResult;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ImagesResult | ErrorResult;  }>((resolve, reject) => {
                    ...
                    if (error) {
						...
						if (response.statusCode && response.statusCode == 200 && response.statusCode <= 299) {
							...
							if(body["code"] === undefined)
								...
								body = ObjectSerializer.deserialize(body, "ErrorResult");
